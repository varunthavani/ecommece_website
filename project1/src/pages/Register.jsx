...
import  Regis  from "../assets/register.webp"
    ...
    return (
        <div className='flex'>
            <div className='w-full md:w-1/2 p-8 flex flex-col justify-center items-center md:p-12 bg-white'>
                <form className='max-w-md flex flex-col border shadow-sm w-full p-8' onSubmit={handleSubmitup}>
                    ...
                    <div className='mb-4'>
                        <label htmlFor="text" className='block text-sm font-semibold mb-2'>Name</label>
                        <input type="text" value={name} onChange={(e) => setName(e.target.value)} className='w-full p-2 border rounded' placeholder='Entar your name' />
                    </div>
                    <div className='mb-4'>
                    ...
                    <div className='text-center'>
                        ...
                        <p>Don't have an account? <Link to="/login" className='text-blue-500' >Log in</Link></p>
                    </div>
                </form>
            </div>
            <div className='hidden md:block w-1/2 bg-gray-800'>
                <div className='w-full flex flex-col h-full items-center'>
                    <img src={Regis} alt="Logon image" className='w-full h-[650px] object-cover' />
                </div>
            </div>
        </div>
    )
